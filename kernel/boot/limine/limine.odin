...
// Request bit 0 asks for x2APIC. Vectra leaves it clear: the LAPIC driver
// speaks the memory-mapped xAPIC, and a bootloader that cannot leave x2APIC
// off refuses to boot rather than hand over a mode nothing here can drive.
MP_X2APIC :: u64(1) << 0
...
MP_Info :: struct {
	...
	lapic_id:       u32,
	reserved:       u64,
	goto_address:   proc "sysv" (info: ^MP_Info) -> !,
	extra_argument: u64,
}
