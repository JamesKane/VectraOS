...
user_programs := [?]User_Program {
	...
	{name = "nstest", path = "tests/nstest"},
	{name = "roletest", path = "tests/roletest"},
	{name = "fdtest", path = "tests/fdtest"},
	{name = "threadtest", path = "tests/thread"},
	{name = "mui", path = "tests/mui"},
	{name = "rastertest", path = "tests/raster"},
	...
	{name = "fedifs", path = "servers/fedifs"},
	{name = "atfs", path = "servers/atfs"},
	{name = "matrixfs", path = "servers/matrixfs"},
...
test_programs := [?]string{
	...
	"mapper", "anon", "sharer", "sharedseg", "treemmio", "treeirq", "treedma", "fixedseg",
...
stage_vectra :: proc(arch: string, host: string) {
	...
	copy_file("lib/namespace", fmt.tprintf("%s/lib/namespace", root))
	copy_file("lib/nsconf", fmt.tprintf("%s/lib/nsconf", root))
	...
	copy_file("tests/page.md", fmt.tprintf("%s/lib/tests/page.md", root))
	...
	copy_file("tests/atnotify.json", fmt.tprintf("%s/lib/tests/atnotify.json", root))
	copy_file("tests/note.json", fmt.tprintf("%s/lib/tests/note.json", root))
