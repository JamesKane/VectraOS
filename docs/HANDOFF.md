...
1. **The desktop.** `docs/WORKBENCH.md` is the plan, and steps 1 to 4
   ...
   (`docs/workbench-step4-desktop.png`). Step 5 is nearly done,
   September 2026: the mouse queue, close as a request, theme reload for
   every toolkit program, `snap`/`minsize`/`maxsize`/`parent`, rules that
