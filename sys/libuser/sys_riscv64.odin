...
/*
The door, five widths of it, and the instruction written as its four bytes.
...
raw1 :: proc "contextless" (nr, a0: u64) -> i64 {
	r, _ := asm(nr, a0: u64) -> (r: i64, n: u64) [nr -> n = %a7, a0 -> r = %a0, #clobber memory, #volatile] { #byte 0x73, 0x00, 0x00, 0x00 }(nr, a0)
	return r
}

@(private)
raw2 :: proc "contextless" (nr, a0, a1: u64) -> i64 {
	r, _, _ := asm(nr, a0, a1: u64) -> (r: i64, n: u64, x1: u64) [nr -> n = %a7, a0 -> r = %a0, a1 -> x1 = %a1, #clobber memory, #volatile] { #byte 0x73, 0x00, 0x00, 0x00 }(nr, a0, a1)
	return r
}

@(private)
raw3 :: proc "contextless" (nr, a0, a1, a2: u64) -> i64 {
	r, _, _, _ := asm(nr, a0, a1, a2: u64) -> (r: i64, n: u64, x1: u64, x2: u64) [nr -> n = %a7, a0 -> r = %a0, a1 -> x1 = %a1, a2 -> x2 = %a2, #clobber memory, #volatile] { #byte 0x73, 0x00, 0x00, 0x00 }(nr, a0, a1, a2)
	return r
}

@(private)
raw4 :: proc "contextless" (nr, a0, a1, a2, a3: u64) -> i64 {
	r, _, _, _, _ := asm(nr, a0, a1, a2, a3: u64) -> (r: i64, n: u64, x1: u64, x2: u64, x3: u64) [nr -> n = %a7, a0 -> r = %a0, a1 -> x1 = %a1, a2 -> x2 = %a2, a3 -> x3 = %a3, #clobber memory, #volatile] { #byte 0x73, 0x00, 0x00, 0x00 }(nr, a0, a1, a2, a3)
	return r
}

@(private)
raw5 :: proc "contextless" (nr, a0, a1, a2, a3, a4: u64) -> i64 {
	r, _, _, _, _, _ := asm(nr, a0, a1, a2, a3, a4: u64) -> (r: i64, n: u64, x1: u64, x2: u64, x3: u64, x4: u64) [nr -> n = %a7, a0 -> r = %a0, a1 -> x1 = %a1, a2 -> x2 = %a2, a3 -> x3 = %a3, a4 -> x4 = %a4, #clobber memory, #volatile] { #byte 0x73, 0x00, 0x00, 0x00 }(nr, a0, a1, a2, a3, a4)
	return r
}
